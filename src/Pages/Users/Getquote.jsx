...
import { faAngleDown, faAngleRight, faAngleUp, faCircleInfo, faPen, faPhone, faTag } from "@fortawesome/free-solid-svg-icons";
...
function Getquote() {
  ...
  const variants = [
    { name: "XUV700 MX Petrol MT 5 STR", price: "Rs. 17.17 Lakh", details: "1997 Cc, Petrol, Manual, 197 Bhp" },
    { name: "XUV700 MX Petrol MT 5 STR", price: "Rs. 17.17 Lakh", details: "1997 Cc, Petrol, Manual, 197 Bhp" },
    { name: "XUV700 MX Petrol MT 5 STR", price: "Rs. 17.17 Lakh", details: "1997 Cc, Petrol, Manual, 197 Bhp" },
    { name: "XUV700 MX Petrol MT 5 STR", price: "Rs. 17.17 Lakh", details: "1997 Cc, Petrol, Manual, 197 Bhp" },
    { name: "XUV700 MX Petrol MT 5 STR", price: "Rs. 17.17 Lakh", details: "1997 Cc, Petrol, Manual, 197 Bhp" },
  ...
  return (
    <div>
      ...
      <div className="px-4 md:px-18 py-4 text-lg pt-24">
        <h1 className="text-2xl sm:text-4xl font-bold">{car.name} Price in Malappuram</h1>
        <p className="sm:py-4">
          Lorem ipsum dolor sit amet consectetur adipisicing elit.
        </p>

        <ul className="capitalize flex gap-4 md:gap-8 text-sm md:text-md flex-wrap justify-cente">
          <li className="cursor-pointer font-medium" onClick={() => scrollToSection("onroad-price")}>On-road Price</li>
          <li className="cursor-pointer font-medium" onClick={() => scrollToSection("price-list")}>Price List</li>
          <li className="cursor-pointer font-medium" onClick={() => scrollToSection("dealers")}>Dealers</li>
          <li className="cursor-pointer font-medium" onClick={() => scrollToSection("faqs")}>FAQs</li>
        </ul>
        ...
        <div className="bg-amber-10 border rounded-md sm:h-[70vh flex flex-col sm:flex-row  gap-2 sm:gap-8 sm:pt-8 pb-4 px-8 my-6">
          <div className="bg-amber-3 border border-gray-300 rounded-sm w-1/3  h-10 flex gap-2 px-1 py-1 text-white absolute">
            <div className="w-1/3 text-center bg-gray-400 rounded-sm" >images</div>
            <div className="w-1/3 text-center bg-gray-400 rounded-sm" >coloures</div>
            <div className="w-1/3 text-center bg-gray-400 rounded-sm" >360 &deg; View</div>
          </div>
          <div
          ...
          <div id="onroad-price" className="sm:leading-8  bg-pink-20">
            ...
            <p className="text-sm opacity-60 py-2">{car.name} price starts from ₹ {car.price} and goes up to ₹ 32.75 Lakh. XUV700 EMI starts from ₹ 28,367.  </p>
            <div className="bg-red-20 flex ">
              <div className="w-1/2 px-4 border border-gray-300 py-2 rounded-l-sm">
                ...
                <p className="font-medium text-sm">MX Petrol MT 5 STR <FontAwesomeIcon icon={faAngleRight} className="opacity-40" /> </p>
              </div>
              <div className="w-1/2 px-4 border border-gray-300 py-2 rounded-r-sm">
                <p className="opacity-50">city</p>
                <p className="font-medium text-sm">Bangalore <FontAwesomeIcon icon={faAngleRight} className="opacity-40" /> </p>
              </div>
            ...
            <p className="opacity-80">
              ...
              Bangalore
              <FontAwesomeIcon icon={faPen} className="text-xs ml-2 opacity-90" />
              <EMI/>
            </p>
            {/* <div className="bg-[#d9d9d96d] w-full h-[20vh] rounded-md text-sm px-2 md:px-4 py-2 mt-2 ">
              <div className="bg-amber-3 border border-gray-300 rounded-sm flex gap-2 px-1 py-1  bg-white">
                <div className="w-1/2 py-1 text-center bg-gray-400 rounded-sm text-white" >Monthly EMI</div>
                <div className="w-1/2 py-1 text-center  rounded-sm" >images</div>           
              </div>
              <div className="flex py-3">
                <div className="flex-1">
                  <p>XUV700 MX Petrol MT 5 STR EMI
                    <p className="font-bold">28,367
                    <span className="text-sm opacity-50 font-normal"> for 5 Years</span>
                    </p>
                    
                  </p>
                </div>
                <button className="border px-8 rounded-sm ">GET EMI Offers</button>
              </div>
              <hr className="text-gray-300"/>


              <button className=" font-medium py-2 w-full">Expand EmI Calculator
        ...
        {/* <div className="bg-amber-300 sm:h-[40vh] flex flex-col sm:flex-row  gap-2 sm:gap-8 pt-4 sm:pt-8 pb-4">
          <div
            className="border border-gray-400 w-1/2 sm:w-full lg:w-1/2 py-12 md:h-5/6 rounded-xl "
            style={{
              background: `url(${car.img})`,
              backgroundRepeat: "no-repeat",
              backgroundSize: "cover",
          ...
          ></div>
          <div id="onroad-price" className="sm:leading-8 w-full ">
            <p>
              {car.name} <FontAwesomeIcon icon={faAngleRight} />
            </p>
            <p>Rs. {car.price} </p>
            <p>
              On Road Price,{" "}
            ...
            <div className="bg-[#D9D9D9] w-full md:w-1/2 rounded-md text-sm px-2 md:px-4 py-2 mt-2 flex items-center justify-between">
              <p>{car.name} price in Kochi starts from 13.52 Lakh </p>
        ...
        <div id="price-list">
          ...
          <div className="border border-gray-400 rounded-xl px-4 py-4 leading-9 max-w-5xl my-4">
            <p className="flex justify-between">
              <span>Ex-Showroom Price <FontAwesomeIcon icon={faCircleInfo} className="opacity-80" /></span> <span>Rs. 11,10,900</span>
            </p>

            {/* Individual Registration Section */}
            <p className="flex justify-between">
              <span className=" underline  decoration-dotted underline-offset-4">Individual Registration  <FontAwesomeIcon icon={faPen} className="opacity-80" /></span> <span>Rs. 1,74,635</span>
            </p>

            {/* Detailed Breakdown Below Individual Registration */}
            <div
              className={`transition-all duration-500 ease-in-out overflow-hidden ${showDetails ? "max-h-[500px] opacity-100 bg-[#f6f6f6d6] " : "max-h-0 opacity-0"
                }`}
            >
              <p className="flex justify-between ">
            ...
            <p className="flex justify-between">
              <span>Insurance  <FontAwesomeIcon icon={faCircleInfo} className="opacity-80" /></span><span>Rs. 53,761</span>
            </p>
            ...
            >
              ...
              <FontAwesomeIcon icon={showDetails
                ? faAngleUp
                : faAngleDown} />
            </p>
        ...
        <div className="border border-gray-400 flex flex-col items-start sm:flex-row md:items-center sm:gap-8 py-4 max-w-5xl px-6">
          ...
          <ul className="leading-8 lg:leading-12">
            ...
            <li><FontAwesomeIcon icon={faPhone} /> 08068441441</li>
            <li className="">Get in touch for the best buying option from your
              authorized dealer</li>
          </ul>
          <button className="bg-[#D9D9D9] px-12 py-3 rounded-md font-medium text-sm">Get the best deal</button>
        </div>


        <div className="py-8 rounded-lg max-w-5xl ">
          <h1 className="sm:text-2xl font-bold mb-4">{car.name} Price In Malappuram (Variant Price List)</h1>

          {/* Filter Buttons */}
          <div className="flex gap-1 sm:gap-3 mb-4">
            {["Petrol", "Diesel", "Manual", "Automatic(TC)"].map((filter) => (
              <button key={filter} className=" text-sm px-2 sm:px-4 py-2 border border-gray-400 rounded-md text-gray-700 hover:bg-gray-200">
                {filter}
              </button>
            ))}
          </div>
          ...
          <div className="border border-gray-300 rounded-md overflow-hidden md:px-8 bg-[#EEE] text-sm sm:text-lg">
            ...
            {variants.slice(0, showMore ? variants.length : 4).map((variant, index) => (
              <div key={index} className="border-t border-gray-300 p-3 grid grid-cols-2">
                <div>
        ...
        <div id="dealers" className="bg-[#EEE] p-4 rounded-lg shadow-md max-w-5xl">
          <h2 className="sm:text-2xl font-bold mb-4">{car.name} Dealers In Malappuram</h2>
        ...
        <div id="faqs" className="bg-[#EEE] p-4 rounded-lg shadow-md mt-4 max-w-5xl">
